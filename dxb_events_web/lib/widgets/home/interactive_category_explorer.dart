  ...
  final categories = [
    {
      ...
      'subCategories': ['Museums', 'Art Galleries', 'Festivals'],
    },
    {
      'id': 'outdoor',
    ...
    },
    {
      ...
      'apiCategories': ['indoor_activities', 'indoor'],
      'tags': ['indoor', 'shopping', 'mall', 'gaming', 'cinema'],
      'gradient': const LinearGradient(
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ...
      'subCategories': ['Malls', 'Gaming', 'Cinema'],
    },
  ];
